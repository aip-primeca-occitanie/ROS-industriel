...
echo_and_run cd "/home/aip/ros_robot_arm/src/modbus/modbus"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/aip/ros_robot_arm/src/modbus/modbus/setup.py" \
     \
    build --build-base "/home/aip/ros_robot_arm/build/modbus/modbus" \
    install \
    --root="${DESTDIR-/}" \
