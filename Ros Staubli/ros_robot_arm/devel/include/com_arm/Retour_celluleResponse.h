// Generated by gencpp from file com_arm/Retour_celluleResponse.msg
// DO NOT EDIT!


#ifndef COM_ARM_MESSAGE_RETOUR_CELLULERESPONSE_H
#define COM_ARM_MESSAGE_RETOUR_CELLULERESPONSE_H
...
struct Retour_celluleResponse_
{
  ...
  typedef boost::shared_ptr< ::com_arm::Retour_celluleResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::com_arm::Retour_celluleResponse_<ContainerAllocator> const> ConstPtr;

}; // struct Retour_celluleResponse_

typedef ::com_arm::Retour_celluleResponse_<std::allocator<void> > Retour_celluleResponse;

typedef boost::shared_ptr< ::com_arm::Retour_celluleResponse > Retour_celluleResponsePtr;
typedef boost::shared_ptr< ::com_arm::Retour_celluleResponse const> Retour_celluleResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::com_arm::Retour_celluleResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::com_arm::Retour_celluleResponse_<ContainerAllocator1> & lhs, const ::com_arm::Retour_celluleResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::com_arm::Retour_celluleResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::com_arm::Retour_celluleResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::com_arm::Retour_celluleResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::com_arm::Retour_celluleResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xeac7c5db26c2bd4eULL;
  static const uint64_t static_value2 = 0xb38c8c1df4b60f0fULL;
};

template<class ContainerAllocator>
struct DataType< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bool ST1\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::com_arm::Retour_celluleResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::com_arm::Retour_celluleResponse_<ContainerAllocator>& v)
  {
    s << indent << "ST1: ";
...
#endif // COM_ARM_MESSAGE_RETOUR_CELLULERESPONSE_H
