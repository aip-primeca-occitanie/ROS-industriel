...
class Retour_celluleRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Retour_celluleRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Retour_celluleRequest
    let len;
    let data = new Retour_celluleRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Retour_celluleRequest(null);
...
class Retour_celluleResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Retour_celluleResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Retour_celluleResponse
    let len;
    let data = new Retour_celluleResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'com_arm/Retour_celluleResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Retour_celluleResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'c27a8c7ce1ff1471d92744cbc43b9273'; },
  datatype() { return 'com_arm/Retour_cellule'; }
};
