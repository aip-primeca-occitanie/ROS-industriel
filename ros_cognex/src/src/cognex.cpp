...
int main(int argc, char **argv)
{
	...
	ros::init(argc, argv, "Camera cognex", ros::init_options::NoSigintHandler);
	...
	//Cognex cognex_staubli_calib(noeud, "kuka", "/calib");
	//Cognex cognex_staubli_objet(noeud, "kuka", "/objet");
return 0 ;
}
